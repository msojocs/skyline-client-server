...
namespace Skyline {
  Napi::FunctionReference *StickyHeaderShadowNode::GetClazz(Napi::Env env) {
    Napi::Function func = DefineClass(
        ...
        {InstanceMethod("setStyleScope", &StickyHeaderShadowNode::setStyleScope),
         ...
         InstanceMethod("forceDetached", &StickyHeaderShadowNode::forceDetached),
         InstanceMethod("spliceRemove", &StickyHeaderShadowNode::spliceRemove),
         InstanceMethod("release", &StickyHeaderShadowNode::release),

         InstanceMethod("setAttributes", &StickyHeaderShadowNode::setAttributes),
         InstanceMethod("getBoundingClientRect",
          ...
          // getter isConnected
          InstanceAccessor("isConnected", &StickyHeaderShadowNode::isConnected, nullptr,
                            static_cast<napi_property_attributes>(
                                napi_writable | napi_configurable)),
         // getter instanceId
         InstanceAccessor("instanceId", &StickyHeaderShadowNode::getInstanceId, nullptr,
                          static_cast<napi_property_attributes>(
                              napi_writable | napi_configurable)),
        });
